...
Given a TidySet remove sets and the related relations and if required
also the elements
...
- `remove_set(object = TidySet, sets = characterORfactor)`: Removes
  everything related to a set
