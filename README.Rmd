...
[![Actions CI](https://github.com/ropensci/BaseSet/workflows/R-CMD-check/badge.svg)](https://github.com/ropensci/BaseSet/actions?query=workflow%3AR-CMD-check)
...
Please note that the BaseSet project is released with a  [Contributor Code of Conduct](https://docs.ropensci.org/BaseSet/CODE_OF_CONDUCT.html).
