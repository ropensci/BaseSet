...
Watch BaseSet working on the [examples](#Examples) below and in the vignettes. You can also find [related packages](#related) and the differences with BaseSet. If you have some questions or bugs [open an issue](https://github.com/llrs/BaseSet/issues) (remember of the [Code of Conduct](#CoC))
