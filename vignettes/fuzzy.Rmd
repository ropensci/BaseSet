...
Note that here there is also a substraction of the fuzzy value.
...
```
Ideally the predicted number of cells per type and the cells with higher conficence about the type should match. 
...
In conclusion, fuzzy sets allows you to look for the roo
