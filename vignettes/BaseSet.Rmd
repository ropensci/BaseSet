...
You can add as much information as you want, with the only restriction for a "fuzzy" column for the `relations()`. See the Fuzzy sets vignette: `vignette("BaseSet: Fuzzy sets", "BaseSet")`.
